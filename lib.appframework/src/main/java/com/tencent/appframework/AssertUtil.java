...
public class AssertUtil {
    ...
    /**
     * Asserts that a condition is true. If it isn't it throws an AssertionFailedError with the
     * given message.
     */
    ...
    /**
     * Asserts that a condition is false. If it isn't it throws an AssertionFailedError with the
     * given message.
     */
     ...
     * AssertionFailedError is thrown with the given message. If the expected value is infinity then
    ...
    /**
     * Asserts that two booleans are equal. If they are not an AssertionFailedError is thrown with
     * the given message.
     */
    ...
    /**
     * Asserts that an object is null. If it isn't an {@link AssertionError} is thrown. Message
     * contains: Expected: <null> but was: object
     * 
