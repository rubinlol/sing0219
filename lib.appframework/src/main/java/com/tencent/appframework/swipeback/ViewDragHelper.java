...
package com.tencent.appframework.swipeback;
...
public class ViewDragHelper {
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        final int action = MotionEventCompat.getActionMasked(ev);//触摸的动作,按下，抬起，滑动，多点按下，多点抬起
        final int actionIndex = MotionEventCompat.getActionIndex(ev);//触控点信息,即表示是哪一个触控点的事件
